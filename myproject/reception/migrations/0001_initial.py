    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departament', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='departament_doctor', to='reception.department')),
            ],
            options={
                'verbose_name': 'Doctor',
            },
